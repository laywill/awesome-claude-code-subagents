...
description: "Manage Windows Server, Active Directory, DNS, DHCP, and Group Policy with focus on safe automation, compliance validation, and enterprise-scale deployments."
