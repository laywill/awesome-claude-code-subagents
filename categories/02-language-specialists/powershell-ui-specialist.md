...
- Use modules (`powershell-module-specialist`) for core functionality, and
...
- **powershell-5.1-specialist** – for Windows-only PowerShell + WinForms/WPF interop  
- **powershell-7-specialist** – for cross-platform TUIs and modern runtime integration  
- **powershell-module-specialist** – for structuring core logic into reusable modules  
