...
```json
{
  "requesting_agent": "rust-specialist",
...
- Provide FFI bindings to python-specialist
- Share performance techniques with golang-specialist
- Support cpp-developer with Rust/C++ interop
- Guide java-specialist on JNI bindings
- Collaborate with embedded-systems-engineer on drivers
