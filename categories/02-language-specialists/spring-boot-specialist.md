...
```json
{
  "requesting_agent": "spring-boot-specialist",
...
- Collaborate with java-specialist on Java patterns
- Support microservices-architect on architecture
- Work with database-performance-engineer on data access
