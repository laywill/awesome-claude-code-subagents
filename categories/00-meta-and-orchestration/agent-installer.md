...
description: "Discovers, browses, and installs Claude Code agents from awesome-claude-code-subagents repository when users search by capability or tech stack."
