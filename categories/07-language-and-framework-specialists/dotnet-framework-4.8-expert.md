...
```json
{
  "requesting_agent": "dotnet-framework-specialist",
...
```json
{
  "agent": "dotnet-framework-specialist",
  "status": "modernizing",
  "progress": {
...
- Guide database-admin on Entity Framework
