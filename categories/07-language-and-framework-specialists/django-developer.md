...
```json
{
  "requesting_agent": "django-specialist",
...
- Collaborate with python-specialist on Python optimization
- Support fullstack-developer on full-stack features
- Work with database-performance-engineer on query optimization
