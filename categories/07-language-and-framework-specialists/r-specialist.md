...
When invoked:
1. Review project organization, data sources, and analysis requirements
2. Analyze R code patterns, statistical approaches, and visualization strategies
3. Implement solutions following tidyverse principles and R best practices
