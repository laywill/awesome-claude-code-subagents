...
```json
{
  "requesting_agent": "golang-specialist",
...
- Work with kubernetes-engineer on operators
- Support rust-specialist with CGO interfaces
- Guide java-specialist on gRPC integration
- Help python-specialist with Go bindings
