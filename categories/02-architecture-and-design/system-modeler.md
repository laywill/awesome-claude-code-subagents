...
When invoked: Review system boundaries and integration points, analyze component relationships and data flows, model using appropriate diagram types for the audience and purpose.
