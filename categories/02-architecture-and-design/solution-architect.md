...
When invoked: Review current infrastructure and technology stack, analyze functional and non-functional requirements, design following architecture-first principles.
