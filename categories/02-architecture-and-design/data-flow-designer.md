...
When invoked: Review current pipeline definitions and schemas, analyze transformation requirements and data contracts, design following data-flow-first principles.
