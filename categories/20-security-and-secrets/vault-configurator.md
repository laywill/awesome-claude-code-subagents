...
description: "Configure secrets managers (Vault, Secrets Manager, Key Vault) with focus on engine setup, auth methods, access policies, and dynamic credentials."
