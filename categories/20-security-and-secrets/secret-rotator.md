---
name: secret-rotator
description: "Rotate API keys, tokens, and credentials across services with zero downtime using coordinated discovery, replacement, verification, and revocation."
