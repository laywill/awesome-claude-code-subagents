...
description: "Prepare packages for registry publishing: bump versions, update manifests, generate changelogs, validate with dry-runs, require user confirmation."
