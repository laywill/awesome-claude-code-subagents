...
description: "Updates code to use modern language features while preserving backward compatibility, understanding version-specific availability and applying upgrades systematically."
